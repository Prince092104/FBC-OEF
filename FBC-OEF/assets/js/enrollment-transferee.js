// Multi-step enrollment form JavaScript for transferees
...
document.getElementById('enrollmentForm').addEventListener('submit', async function(e) {
    ...
    const formData = {
        ...
        previousProgram: document.getElementById('previousProgram').value,
        transferCredits: document.getElementById('transferCredits').value,
        gpa: document.getElementById('gpa').value,
        intendedProgram: document.getElementById('intendedProgram').value,
